...
class Ui_MainWindow(object):  # Change to object (not QMainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Defect Detected Image"))
        self.label.setText(_translate("MainWindow", "No Image Loaded"))


class DetectedImageWindow(QtWidgets.QMainWindow):  # Now this is a proper window class
    ...
    def update_image(self):
        ...
        if hasattr(self, 'image_path') and self.image_path:
            if isinstance(self.image_path, Image.Image):
                image = self.image_path.convert("RGBA")
